...
type PostExampleJSONRequest struct {
	Body Body
}
type PostExampleJSONResponse200 struct {
}
type PostExampleJSONResponse struct {
	StatusCode  int
	Response200 *PostExampleJSONResponse200
}
`,
			expectedHandlers: `// Code generated by github.com/jolfzverb/codegen; DO NOT EDIT.
...
type PostExampleJSONHandler interface {
	HandlePostExampleJSON(ctx context.Context, r *models.PostExampleJSONRequest) (*models.PostExampleJSONResponse, error)
}
type Handler struct {
	validator       *validator.Validate
	postExampleJSON PostExampleJSONHandler
}

func NewHandler(postExampleJSON PostExampleJSONHandler) *Handler {
	return &Handler{validator: validator.New(validator.WithRequiredStructEnabled()), postExampleJSON: postExampleJSON}
}
func (h *Handler) AddRoutes(router chi.Router) {
	router.Post("/example", h.handlePostExample)
}
func (h *Handler) parsePostExampleJSONRequestBody(r *http.Request) (*models.Body, error) {
...
func (h *Handler) parsePostExampleJSONRequest(r *http.Request) (*models.PostExampleJSONRequest, error) {
	body, err := h.parsePostExampleJSONRequestBody(r)
	if err != nil {
		return nil, err
	}
...
func (h *Handler) writePostExampleJSONResponse(w http.ResponseWriter, response *models.PostExampleJSONResponse) {
	...
	case 200:
		...
		h.writePostExampleJSON200Response(w, response.Response200)
	}
	w.WriteHeader(response.StatusCode)
}
func (h *Handler) handlePostExampleJSON(w http.ResponseWriter, r *http.Request) {
	request, err := h.parsePostExampleJSONRequest(r)
	if err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	ctx := r.Context()
	response, err := h.postExampleJSON.HandlePostExampleJSON(ctx, request)
	if err != nil || response == nil {
		http.Error(w, "InternalServerError", http.StatusInternalServerError)
		return
	}
	h.writePostExampleJSONResponse(w, response)
	return
}
func (h *Handler) handlePostExample(w http.ResponseWriter, r *http.Request) {
	switch r.Header.Get("Content-Type") {
	case "application/json":
		h.handlePostExampleJSON(w, r)
		return
	case "":
		h.handlePostExampleJSON(w, r)
		return
...
type OpJSONRequest struct {
	Body Body
}
type OpJSONResponse200 struct {
}
type OpJSONResponse struct {
	StatusCode  int
	Response200 *OpJSONResponse200
}
`,
			expectedHandlers: `// Code generated by github.com/jolfzverb/codegen; DO NOT EDIT.
...
type OpJSONHandler interface {
	HandleOpJSON(ctx context.Context, r *models.OpJSONRequest) (*models.OpJSONResponse, error)
}
type Handler struct {
	validator *validator.Validate
	opJSON    OpJSONHandler
}

func NewHandler(opJSON OpJSONHandler) *Handler {
	return &Handler{validator: validator.New(validator.WithRequiredStructEnabled()), opJSON: opJSON}
}
func (h *Handler) AddRoutes(router chi.Router) {
	router.Post("/example", h.handleOp)
}
func (h *Handler) parseOpJSONRequestBody(r *http.Request) (*models.Body, error) {
	var body models.Body
	err := json.NewDecoder(r.Body).Decode(&body)
	if err != nil {
		return nil, err
...
func (h *Handler) parseOpJSONRequest(r *http.Request) (*models.OpJSONRequest, error) {
	body, err := h.parseOpJSONRequestBody(r)
	if err != nil {
		return nil, err
	}
...
func (h *Handler) writeOpJSONResponse(w http.ResponseWriter, response *models.OpJSONResponse) {
	switch response.StatusCode {
	case 200:
		if response.Response200 == nil {
			http.Error(w, "InternalServerError", http.StatusInternalServerError)
		...
		h.writeOpJSON200Response(w, response.Response200)
	}
	w.WriteHeader(response.StatusCode)
}
func (h *Handler) handleOpJSON(w http.ResponseWriter, r *http.Request) {
	request, err := h.parseOpJSONRequest(r)
	if err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	ctx := r.Context()
	response, err := h.opJSON.HandleOpJSON(ctx, request)
	if err != nil || response == nil {
		http.Error(w, "InternalServerError", http.StatusInternalServerError)
		return
	}
	h.writeOpJSONResponse(w, response)
	return
}
