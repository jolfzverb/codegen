...
func (g *Generator) AddParseQueryParamsMethod(baseName string, params openapi3.Parameters) error {
	...
	fn := astbuilder.NewFunctionBuilder().
		...
		AddResult(astbuilder.NewFieldBuilder().WithType(astbuilder.Star(astbuilder.SimpleType(g.GetCurrentModelsPackage(), baseName+"QueryParams")))).
...
func (g *Generator) AddParseHeadersMethod(baseName string, params openapi3.Parameters) error {
	...
	fn := astbuilder.NewFunctionBuilder().
		...
		WithPointerReceiver("h", "Handler").
		AddParam(astbuilder.NewFieldBuilder().WithName("r").WithType(astbuilder.Star(astbuilder.SimpleType("http", "Request")))).
		AddResult(astbuilder.NewFieldBuilder().WithType(astbuilder.Star(astbuilder.SimpleType(g.GetCurrentModelsPackage(), baseName+"Headers")))).
		AddResult(astbuilder.ErrorField()).
		WithBody(bodyBuilder)
...
func (g *Generator) AddParseCookiesMethod(baseName string, params openapi3.Parameters) error {
	...
	fn := astbuilder.NewFunctionBuilder().
		...
		WithPointerReceiver("h", "Handler").
		AddParam(astbuilder.NewFieldBuilder().WithName("r").WithType(astbuilder.Star(astbuilder.SimpleType("http", "Request")))).
		AddResult(astbuilder.NewFieldBuilder().WithType(astbuilder.Star(astbuilder.SimpleType(g.GetCurrentModelsPackage(), baseName+"Cookies")))).
		AddResult(astbuilder.ErrorField()).
		WithBody(bodyBuilder)
...
func (g *Generator) AddParseRequestBodyMethod(baseName string, contentType string, body *openapi3.RequestBodyRef) error {
	...
	bodyType = astbuilder.SimpleType(g.GetCurrentModelsPackage(), typeName)
	...
	bodyBuilder.AddStmt(astbuilder.DeclareVarWithType("bodyJSON", astbuilder.SimpleType("json", "RawMessage")))
...
func (g *Generator) AddParseRequestMethod(baseName string, contentType string, pathParams openapi3.Parameters,
	...
	bodyBuilder.AddStmt(astbuilder.Return2(
		astbuilder.Amp(astbuilder.CompositeLit(
			astbuilder.SimpleType(g.GetCurrentModelsPackage(), baseName+"Request"),
			elts...,
		)),
		astbuilder.I("nil")))
	...
	fn := astbuilder.NewFunctionBuilder().
		...
		WithPointerReceiver("h", "Handler").
		AddParam(astbuilder.NewFieldBuilder().WithName("r").WithType(astbuilder.Star(astbuilder.SimpleType("http", "Request")))).
		AddResult(astbuilder.NewFieldBuilder().WithType(astbuilder.Star(astbuilder.SimpleType(g.GetCurrentModelsPackage(), baseName+"Request")))).
		AddResult(astbuilder.ErrorField()).
		WithBody(bodyBuilder)
