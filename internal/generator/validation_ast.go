...
func (g *Generator) AddObjectValidate(modelName string, schema *openapi3.SchemaRef) error {
	...
	if len(requiredFields) > 0 {
		requiredFieldsElts := make([]astbuilder.TypeExpressionBuilder, 0, len(requiredFields))
		...
		nullableFieldsElts := make([]astbuilder.TypeExpressionBuilder, 0, len(nullableFields))
